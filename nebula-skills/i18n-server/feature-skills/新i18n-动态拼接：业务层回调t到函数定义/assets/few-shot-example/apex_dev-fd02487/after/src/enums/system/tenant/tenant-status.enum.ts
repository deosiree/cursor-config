...
export const TENANT_STATUS_VO_CONFIG: Record<TenantStatusVO, TenantStatusMeta> = {
  unspecified: { label: trans("未指定"), type: "info" },
  active: { label: trans("正常"), type: "success" },
  disabled: { label: trans("停用"), type: "danger" },
  expired: { label: trans("过期"), type: "warning" },
  locked: { label: trans("锁定"), type: "warning" },
  activation: { label: trans("待激活"), type: "primary" },
};
