<template>
  <div class="tenant-form-fields">
    <div v-if="title" class="tenant-form-fields__header">{{ title }}</div>
    <el-form
      ref="formRef"
      :model="innerModel"
      :rules="rules"
    ...
    >
      <el-form-item prop="tenantName">
        <template #label>
          <div class="inline-flex items-center gap-1">
            <span>租户名</span>
            <el-tooltip placement="top" content="必填，1-64 个字符，仅支持中文、字母、数字和下划线">
      ...
      <el-form-item label="钉钉群" prop="dingtalk">
        <el-input
          ...
          placeholder="输入钉钉群链接，如https://dingdingxxxxxx"
          maxlength="1024"
          clearable
          :disabled="readonlyMode"
        />
      ...
      <el-form-item label="钉钉群密钥" prop="dingtalkSecret">
        <el-input
          v-model="innerModel.dingtalkSecret"
          placeholder="请输入钉钉群密钥"
          type="password"
          show-password
          maxlength="1024"
          clearable
...
import { collectFormValidationErrors, tenantNameRules } from "@/utils/formRules";
