---
name: 新i18n-ts或script setup中使用t(),可以包变量 few-shot 入口
description: 当需要在主模板之外，为 `新i18n-ts或script setup中使用t(),可以包变量` 选择更贴近当前仓库形态的 few-shot 时使用。
---

# 新i18n-ts或script setup中使用t(),可以包变量 few-shot 入口
