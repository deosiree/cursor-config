export default {
  ...
  dashboard: {
    kpi: {
      ...
      online: "Online",
      offline: "Offline",
      notActivated: "Not Running",
      disabled: "Disabled",
      unallocated: "Unallocated",
    },
    chart: {
      userStatusTitle: "User Status Distribution",
      resourceUsageTitle: "Resource Usage",
      deviceStatusTitle: "Device Status",
      selectProjectPlaceholder: "Please select project",
      selectDevicePlaceholder: "Please select device model",
      accessDevicesPrefix: "Access devices:",
      used: "Used",
      unused: "Unused",
      availableResource: "Available Resources",
      allocationTitle: "Allocation Status",
      allocated: "Allocated",
      unallocated: "Unallocated",
      allocatedDeviceStatusTitle: "Allocated Devices Status",
    },
  },
};
