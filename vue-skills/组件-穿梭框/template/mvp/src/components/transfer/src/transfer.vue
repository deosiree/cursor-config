...
const leftPanelTitle = computed(() => props.titles[0] || t("列表 1"));

const rightPanelTitle = computed(() => props.titles[1] || t("列表 2"));

const panelFilterPlaceholder = computed(() => props.filterPlaceholder || t("请输入搜索内容"));
