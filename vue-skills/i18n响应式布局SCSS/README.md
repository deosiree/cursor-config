...
Vue + Element Plus 项目的 **locale-layout 国际化布局** skill：preset 四档（sm/md/lg/xl）+ 侧栏 SCSS 消费。

## 解决什么问题

- 切换语言后布局尺寸不变（侧栏、form label、查询框）
...
├── feature-skills/扩展-已有locale-layout侧栏   → template/before|after/apex-dev
...
| apex 扩展 after | `apex_dev` 工作区/暂存 | sidebarWidth 四档 + LeftLayout |
...
locale-layout、$localeLayout、sidebarWidth、国际化布局、响应式布局、LayoutSize、formLabel.md、侧栏宽度、menu.scss 200px、切换语言布局、i18n响应式布局SCSS
