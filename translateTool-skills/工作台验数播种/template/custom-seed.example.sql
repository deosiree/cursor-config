...
-- ========== 必改变量 ==========
SET @product_id = '__PRODUCT_ID__';
SET @task_id = '__TASK_ID__';
SET @task_name = '__TASK_NAME__';
SET @department = '通用平台部';
SET @translate_type = '英文';
SET @admin_uid = '__USER_ID__';          -- t_user.id（本地 admin）
SET @personnel = 'admin';                 -- 五角色同名时可全用此值
SET @id_prefix = 'verify-custom';         -- 词条/relation/translate id 前缀，勿与他档案冲突
