...
```bash
node common-skills/生图skills/gpt-image-2/gpt-image-2/scripts/check-mode.js
# 想拿结构化结果给上层程序用：
node common-skills/生图skills/gpt-image-2/gpt-image-2/scripts/check-mode.js --json
```
...
```bash
node common-skills/生图skills/gpt-image-2/gpt-image-2/scripts/generate.js \
...
```bash
node common-skills/生图skills/gpt-image-2/gpt-image-2/scripts/edit.js \
