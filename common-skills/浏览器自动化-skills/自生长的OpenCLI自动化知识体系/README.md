...
> **持续评估：** 每次实跑结果记录在 [`evals/实跑记录.tsv`](evals/实跑记录.tsv)，PASS / FAIL 都有据可查。
...
| API 白名单表格 E2E | `opencli-ux-api-whitelist/` | 真实插种 50 条 + 弹窗表格滚动断言 |
...
├── opencli-ux-api-whitelist/    # 菜单 API 白名单弹窗 E2E 子 skill
