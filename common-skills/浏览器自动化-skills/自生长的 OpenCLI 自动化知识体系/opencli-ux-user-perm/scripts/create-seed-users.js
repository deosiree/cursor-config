 ...
 * Skill: .cursor/nebula-skills/opencli-ux-user-perm/
 * 用法：opencli browser user0601 eval "$(Get-Content -Raw '.cursor/nebula-skills/opencli-ux-user-perm/scripts/create-seed-users.js')"
 */
