...
- **阶段 1 必需** - 不能跳到实施
- **单一假设规则** - 强制思考，防止散弹枪修复
- **明确失败模式** - "如果你的第一次修复不起作用"带强制行动
- **反模式部分** - 显示捷径的确切样子

### 冗余
- 根本原因要求在概述 + when_to_use + 阶段 1 + 实施规则中
...
**最重要的加固：** 反模式部分显示在当下感觉合理的确切捷径。当 Claude 想"我只是添加这个快速修复"时，看到该确切模式被列为错误会产生认知摩擦。
